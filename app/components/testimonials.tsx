...
const Testimonials = () => {
  ...
  <h2 className="font-roboto font-[700] text-[48px] text-center leading-[57.6px]">Customer testimonials</h2>
  <p className="font-roboto font-[400] text-[18px] leading-[27px] text-center py-[10px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
</div>
        ...
        <div className='flex flex-row justify-between mx-[70px] w-[1152px] h-[417.89px] gap-[48px] '>
            <div className='flex flex-col w-[362.67px] h-[321.89px] py-[20px] border-[1px] border-solid border-[#000000] gap-[24px] '>
                <div className='flex flex-row mx-[20px]  w-[116px] h-[18.89px] gap-[4px] '>
                    <Image src={"/fivestar.svg"} alt='' width={20} height={18.89}/>
                    <Image src={"/fivestar.svg"} alt='' width={20} height={18.89}/>
                    <Image src={"/fivestar.svg"} alt='' width={20} height={18.89}/>
                    <Image src={"/fivestar.svg"} alt='' width={20} height={18.89}/>
                    <Image src={"/fivestar.svg"} alt='' width={20} height={18.89}/>
                ...
                <div className='flex flex-col w-[298.67px] h-[215px] gap-24px '>
                    <p className='w-[320px] h-[108px] font-roboto font-[400] text-[18px] leading-[27px] mx-[20px] my-[20px] '>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."</p>
                    <div className='flex flex-row items-center justify-between w-[254px] h-[56px] gap-[20px] '>
                        <Image className='rounded-[50%] mx-[20px]' src={"/Image3.svg"} alt='' width={56} height={56}/>
            ...
            <div className='flex flex-col w-[362.67px] h-[321.89px] py-[20px] border-[1px] border-solid border-[#000000] gap-[24px] '>
                ...
                <div className='flex flex-col w-[298.67px] h-[215px] gap-24px '>
                    <p className='w-[320px] h-[108px] font-roboto font-[400] text-[18px] leading-[27px]  mx-[20px] my-[20px] '>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."</p>
                    <div className='flex flex-row items-center justify-between w-[254px] h-[56px] gap-[20px] '>
                        <Image className='rounded-[50%] mx-[20px]' src={"/Image1.svg"} alt='' width={56} height={56}/>
                        <div className='flex flex-col justify-between w-[178px] h-[48px] '>
            ...
            <div className='flex flex-col w-[362.67px] h-[321.89px] py-[20px] border-[1px] border-solid border-[#000000] gap-[24px] '>
                ...
                <div className='flex flex-col w-[298.67px] h-[215px] gap-24px '>
                    <p className='w-[320px] h-[108px] font-roboto font-[400] text-[18px] leading-[27px]  mx-[20px] my-[20px] '>"Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare."</p>
                    <div className='flex flex-row items-center justify-between w-[254px] h-[56px] gap-[20px] '>
                        <Image className='rounded-[50%] mx-[20px]' src={"/Image6.svg"} alt='' width={56} height={56}/>
                        <div className='flex flex-col justify-between w-[178px] h-[48px] '>
        ...
        <div className='flex flex-row justify-between mx-[70px] w-[1280px] h-[48px]'>
                ...
                <div className='flex flex-row mx-[130px] w-[111px] h-[48px] gap-[15px]'>
                    <Image className='gap-[8px] pb-2' src="/LeftButton.svg" alt="" width={48} height={48} />
                    <Image className='gap-[8px] pb-2' src="/RightButton.svg" alt="" width={48} height={48} />
                </div>
            </div>
    </section>
    </>
